...
export default function Footer() {
  ...
  const serviceLinks = Object.values(t.services).map(service => service.title);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Image src="/brandlogowhite.svg"
              alt="Byalance" width={240} height={80} loading="lazy" className="h-14 w-auto md:h-18 mb-1 ml-[-2px]"/>
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="text-gray-300 hover:text-white text-xl"
              >
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 0C8.74 0 8.333.015 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.74 0 12s.015 3.667.072 4.947c.2 4.358 2.618 6.78 6.98 6.98C8.333 23.985 8.74 24 12 24s3.667-.015 4.947-.072c4.358-.2 6.78-2.618 6.98-6.98.058-1.28.072-1.689.072-4.948s-.015-3.667-.072-4.947c-.2-4.358-2.618-6.78-6.98-6.98C15.667.015 15.26 0 12 0zm0 2.16c3.203 0 3.585.012 4.85.07 3.25.148 4.77 1.69 4.92 4.92.058 1.265.07 1.646.07 4.85s-.012 3.585-.07 4.85c-.15 3.23-1.67 4.77-4.92 4.92-1.265.058-1.646.07-4.85.07s-3.585-.012-4.85-.07c-3.25-.15-4.77-1.67-4.92-4.92-.058-1.265-.07-1.646-.07-4.85s.012-3.585.07-4.85c.15-3.23 1.67-4.77 4.92-4.92C8.415 2.172 8.797 2.16 12 2.16zm0 3.66c-3.32 0-6.02 2.7-6.02 6.02s2.7 6.02 6.02 6.02 6.02-2.7 6.02-6.02-2.7-6.02-6.02-6.02zm0 9.88c-2.12 0-3.84-1.72-3.84-3.84s1.72-3.84 3.84-3.84 3.84 1.72 3.84 3.84-1.72 3.84-3.84 3.84zm6.4-11.8c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span dangerouslySetInnerHTML={{ __html: t.footer.phone }}></span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
           <div className="text-gray-400 text-sm">
             ...
             <Link href="/data-handling" className="hover:text-white">{t.footer.dataHandlingPolicy}</Link>
           </div>
