...
export default function HeroSection() {
  ...
  return (
    <section className="bg-gradient-to-br from-primary-50 to-white pt-12 pb-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="font-bold text-gray-900 mb-4 md:mb-6 min-h-[8rem] md:min-h-[6rem] flex items-center justify-center">
            <span
              key={currentIndex}
              className={`animate-fade-in-up ${isTamil ? "text-3xl md:text-5xl" : "text-4xl md:text-6xl"}`}
            >
              {currentItem.text}.
            </span>
          </h1>
